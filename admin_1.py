...
class Admin:
    ...
    def add_item(self):
        ...
        try:
            ...
            content = {1:{"Name":"Tandoori Chicken","Quantity":"(4 piece)","Price":240,"Discount":"5%"},
            2:{"Name":"Vegan Burger", "Quantity":"(1 Piece)", "Price":320,"Discount":"15%"},
            3:{"Name":"Tuffle Cake", "Quantity":"(500 gm)", "Price":900,"Discount":"10%"}}
    ...
    def edit_food_items(self, id):
        try:
            ...
            file1 = open("food_items.json","w+")
            food_items = {1:{"Name":"Tandoori Chicken","Quantity":"(4 piece)","Price":240,"Discount":"5%"},
            2:{"Name":"Vegan Burger", "Quantity":"(1 Piece)", "Price":320,"Discount":"15%"},
            3:{"Name":"Tuffle Cake", "Quantity":"(500 gm)", "Price":900,"Discount":"10%"}}
    ...
    def stock(self):
        print("Stock Left:\nTandoori chicken : 12kg\nVegan Burger : 45 pieces\nTuffle Cake : 60 pieces\n")

def admin():
    b2 = Admin()
    admin_name = "krishna"
    admin_password = "6542"
    input_name = input("Enter admin name:(krishna)\n")
    input_password = input("Enter admin password:(6542)\n")
